    ...
    <div className="flex min-h-screen">
      ...
      <aside className="hidden lg:flex flex-col w-64 h-screen sticky top-0 bg-surface-container-low p-4 gap-2">
        ...
        <div className="pt-6 border-t border-outline-variant/10 flex flex-col gap-1">
          ...
          <a href="#" className="flex items-center gap-3 px-4 py-3 text-secondary hover:bg-surface-container-high rounded-xl transition-all text-sm font-medium">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-10">
            <div className="bg-surface-container-lowest p-6 md:p-8 rounded-3xl flex flex-col gap-4 group hover:bg-white hover:shadow-xl transition-all duration-500 border border-transparent hover:border-outline-variant/10">
              ...
              <div>
                ...
                <p className="text-4xl font-black text-on-surface mt-1">1,284</p>
              </div>
            ...
            <div className="bg-surface-container-lowest p-6 md:p-8 rounded-3xl flex flex-col gap-4 group hover:bg-white hover:shadow-xl transition-all duration-500 border border-transparent hover:border-outline-variant/10">
              <div className="flex justify-between items-start">
                ...
                <span className="text-tertiary text-sm font-bold flex items-center gap-1">
                  <span className="material-symbols-outlined text-sm">check</span> 84%
                </span>
              </div>
              <div>
                <p className="text-on-surface-variant font-bold text-xs uppercase tracking-widest">Completed Screenings</p>
                <p className="text-4xl font-black text-on-surface mt-1">942</p>
              </div>
              <div className="w-full h-1 bg-surface-container-high rounded-full overflow-hidden">
                <div className="h-full bg-tertiary w-[84%]" />
              </div>
            </div>
            ...
            <div className="bg-on-secondary-fixed p-6 md:p-8 rounded-3xl flex flex-col gap-4 text-white relative overflow-hidden hover:shadow-xl transition-all duration-500 sm:col-span-2 lg:col-span-1">
              ...
              <div className="relative z-10">
                ...
                <p className="text-4xl font-black mt-1">47</p>
              </div>
                    ...
                    <tr key={c.id} className="hover:bg-surface-container-low/30 transition-colors">
                      <td className="px-6 md:px-8 py-5">
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 rounded-xl bg-secondary/10 flex items-center justify-center text-secondary font-bold text-sm flex-shrink-0">
                            {c.initials}
                          </div>
                          <div>
                      ...
                      <td className="px-6 md:px-8 py-5">
                        <div className="flex items-center gap-3">
                          <div className="flex-1 h-2 bg-surface-container-high rounded-full overflow-hidden min-w-[60px]">
                            ...
                            {!c.score && <div className="h-full bg-primary/30 w-[45%]" />}
                          </div>
                          <span className={`text-sm font-black ${c.scoreColor}`}>{c.score ? `${c.score}%` : "—"}</span>
                        </div>
                      </td>
                      <td className="px-6 md:px-8 py-5 text-right">
                        <Link
                          href={`/recruiter/interviews/${c.id}`}
                          className="p-2 text-secondary hover:text-primary transition-colors inline-flex"
                        >
